    ...
    public class GameLogicTests
    {
        ...
        public class GameScoreBoard
        {
            ...
            public void testFileAdd()
            {
                ...
                logic.x = logic.y = 4; // New record data
                logic.player1GamesWon = 4;
                logic.player1TotalScore = 36;
                string name = "Test";
                string expected = "Test 4x4 4 36";
                List<string> text, text2; // string Lists for files

                // act
                text2 = File.ReadAllLines(path2).ToList();
                File.WriteAllLines(path, text2);
                board.ScoreAdd(name, logic.player1TotalScore, logic.x, logic.y, logic.player1GamesWon);
                text2 = File.ReadAllLines(path).ToList();
                ...
                // assert
                Assert.AreEqual(expected, text[6]);
                Assert.AreEqual(expected, text2[2]);
            }
        }
